...
void playSongAsaBranca() {
  lcd.clear();
  //Posiciona o cursor na coluna 3, linha 0;
  lcd.setCursor(3, 0);

  lcd.print("Luiz Gonzaga");
  lcd.setCursor(3, 1);
  lcd.print("Asa Branca");
  delay(1000);
  ...
  int melody[] = {
    ...
    // Notas: https://musescore.com/user/190926/scores/181370
  ...
  // sizeof retorna o númemo de bytes, cada valor int é composto por 2 bytes(16bits)
  int notes = sizeof(melody) / sizeof(melody[0]) / 2;

  // Calcula a duração da nota em ms
